  ...
  return (
    <section className="py-24 bg-[#FFFBEC] relative">
      <div className="max-w-[90rem] mx-auto px-12 relative z-10">
        {/* Section Heading */}
        <h2 className="text-5xl md:text-7xl font-bold text-[#115e71] mb-6 relative text-center">
          Apartment Amenities
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {categories.map((category, index) => {
            ...
            return (
              ...
              >
                {/* Centered Heading */}
                <h3 className="text-3xl font-bold text-[#115e71] text-center border-b border-[#e1bc6a] pb-3">
                  {category.name}
                </h3>
