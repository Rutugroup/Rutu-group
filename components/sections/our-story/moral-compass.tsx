  ...
  return (
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="relative w-full overflow-hidden rounded-lg md:h-[500px] h-[750px] pt-0 md:pt-40 bg-[#d2a774]">
          ...
          <div className="relative z-10 flex flex-col md:flex-row bg-opacity-70 p-8 md:p-12 h-1/2">
            <div className="w-full md:w-1/2 flex flex-col justify-start md:justify-center">
              ...
              <p className="text-gray-700 mb-4 text-md md:text-xl">
              ...
              <p className="hidden md:block text-gray-700 mb-4 text-md md:text-xl">
